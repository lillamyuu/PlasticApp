...
class MyResult(var classIndex: Int, var score: Float)
object PrePostProcessor {
    ...
    var mInputWidth = 416
    var mInputHeight = 416

    // model output is of size 25200*(num_of_class+5)
    private const val mOutputRow =
        10647 // as decided by the YOLOv5 model for input image of size 640*640
    private const val mOutputColumn = 13 // left, top, right, bottom, score and 8 class probability
